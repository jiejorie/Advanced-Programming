...
class MyGUI(Tk):
    ...
    # updates greeting message based on entry and option menu input
...
class InputFrame(Frame):
    ...
    def __init__(self, parent):
        ...
        # initializes variables for option menu widget
...
# holds the Display frame widgets
...
# calls main if script is being directly run
